...
2026-06-26T17:49:24Z：已基于 OR-M0-001 negative smoke 启动机制级 pivot，选择 `GRAFT-GCL / Graph Prior-Task Fitted Contrastive Learning` 作为新候选。GRAFT 不继续 operator response / response basis / teacher response 路线，而将 supervision object 改为同一真实图上的 label-free node-classification task prior。
